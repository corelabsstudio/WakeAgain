...
def _welcome_html(name: str, lang: str) -> str:
    if lang == "ko":
        ...
        body = (
            ...
            "매물로 올려보세요. <strong>지금 올리시면 첫 50개 매물 안에 드셔서, 팔릴 때 성사 수수료가 "
            "10%가 아니라 0%</strong>로 자동 적용됩니다. 따로 신청하실 필요 없이 등록하시는 순간 바로 붙어요.</p>"
        ...
        body = (
            ...
            "working on, WakeAgain is built exactly for that — list it. "
            "<strong>List now and you'll land in our first 50 listings, which pay a 0% success fee "
            "instead of the usual 10%</strong> — applied automatically the moment you list, no need "
            "to ask.</p>"
...
def send_welcome_email(to: str, name: str = "", lang: str = "en") -> bool:
    ...
    if lang == "ko":
        ...
        text = (
            ...
            "매물로 올려보세요. 지금 올리시면 첫 50개 매물 안에 드셔서, 팔릴 때 성사 수수료가 10%가 아니라 "
            "0%로 자동 적용됩니다. 따로 신청하실 필요 없이 등록하시는 순간 바로 붙어요.\n\n"
            "궁금한 점 있으시면 답장 주세요 -- 제가 직접 다 읽습니다.\n\n"
            "-- 호현수, WakeAgain\n"
        )
        ...
        text = (
            ...
            "working on, WakeAgain is built exactly for that -- list it. List now and you'll land in "
            "our first 50 listings, which pay a 0% success fee instead of the usual 10% -- applied "
            "automatically the moment you list, no need to ask.\n\n"
            "Questions? Just hit reply -- I read every email myself.\n\n"
            "-- Hyunsoo, WakeAgain\n"
        )
