...
(function (global) {
  ...
  var STR = {
    ko: {
      ...
      "buyers.title": "0부터 다시 만들기 전에,<br /><span class=\"grad\">초안을 만나세요</span>.",
      "buyers.lead": "직접 만들 수 있습니다. 다만 주말 몇 주를 또 쓸 거면, 데모가 있는 프로젝트를 사는 편이<br />더 빠를 수 있어요. 구매 시 추가 수수료는 없습니다.<br />낙찰 시 판매자 수익에서 수수료가 차감됩니다.",
      "buyers.safe_badge": "안전결제 · 구매자 보호",
      "buyers.safe_title": "PG연동 결제 시스템",
    ...
    en: {
      ...
      "buyers.title": "Before you rebuild from zero,<br /><span class=\"grad\">meet a draft</span>.",
      "buyers.lead": "You can build it yourself. If that means more weekends, buying a demo-ready project may be<br />faster. No extra fee for buyers.<br />The fee is taken from the seller’s proceeds when a deal closes.",
      "buyers.safe_badge": "Safe pay · buyer protection",
      "buyers.safe_title": "PG-linked payment system",
