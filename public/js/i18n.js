...
(function (global) {
  ...
  var STR = {
    ko: {
      ...
      "home.event_banner": "이벤트 진행 중 · 소문 내고 성사 수수료 8% 쿠폰 받기 (계정당 1회)",
      "home.event_cta": "이벤트 참여 →",
      "home.event_btn": "소문내고 8% 쿠폰",
      ...
      "list.loading": "불러오는 중…",
      "list.public": "판매가와 제안 금액은 사이트에 들어온 모든 사람에게 공개됩니다.",
      "list.all": "전체",
      ...
      "list.source_api": "판매 중 매물 · 판매가 공개 · 4초마다 갱신",
      "list.source_preview": "아직 등록 매물이 없어 예시입니다. 매물이 올라오면 판매가가 전원에게 공개됩니다.",
      "list.badge_sample": "예시",
      "list.badge_sold": "팔림",
      "list.badge_ended": "끝남",
      "list.badge_sale": "판매 중",
      "list.badge_review": "검토 중",
      "list.price_ask": "판매가",
      "list.price_ask_pub": "판매가 · 공개",
      "list.offers_none": "아직 제안 없음",
      "list.price": "가격",
      "list.inquire": "문의",
      "list.cta_offer": "보고 제안하기",
      "list.cta_view": "프로젝트 자세히 보기",
      "cta.title": "프로젝트에 두 번째 기회를 주세요.",
      "cta.strong": "멈춘 프로젝트를 다시 살립니다. 등록 무료 · 판매 수수료 10%.",
      "cta.fine": "올리기·관심·가격 제안까지는 쉽게. 올리는 건 무료입니다. 대신 팔리면 규칙을 지킵니다 — 빠른 입금, 안 내면 성사 취소, 판매자 수수료 10%. (1시간 자동 타이머는 PG 후)",
    ...
    en: {
      ...
      "home.event_banner": "Live event · Share WakeAgain, earn an 8% seller-fee coupon (once per account)",
      "home.event_cta": "Join event →",
      "home.event_btn": "Share · 8% coupon",
      ...
      "hero.stats_note": "",
      "live.price": "Asking price",
      "live.time": "Listed until",
      "live.progress": "Asking price · offers",
      "live.ecg": "VITAL · ALIVE",
      "live.toast": "New offer · view",
      ...
      "safe4.s1_t": "Checkout",
      "safe4.s1_d": "Pay within 1 hour of the sale being agreed",
      ...
      "list.public": "Asking prices and offers are public—every visitor sees the same numbers.",
      "list.all": "All",
      ...
      "list.source_api": "Live listings · asking prices public · refreshes every 4s",
      "list.source_preview": "No live listings yet — samples shown. Asking prices go public once listings land.",
      "list.badge_sample": "Sample",
      "list.badge_sold": "Sold",
      "list.badge_ended": "Ended",
      "list.badge_sale": "For sale",
      "list.badge_review": "Under review",
      "list.price_ask": "Asking price",
      "list.price_ask_pub": "Asking price · public",
      "list.offers_none": "No offers yet",
      "list.price": "Price",
      "list.inquire": "Inquire",
      "list.cta_offer": "View & make an offer",
      ...
      "cta.fine": "Free to list. After a sale: pay on time, the sale is cancelled if missed, 10% seller fee.",
