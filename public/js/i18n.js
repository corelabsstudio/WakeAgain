...
(function (global) {
  ...
  var STR = {
    ko: {
      ...
      "buyers.lead": "직접 만들 수 있습니다. 다만 주말 몇 주를 또 쓸 거면, 데모가 있는 프로젝트를 사는 편이<br />더 빠를 수 있어요. 구매 시 추가 수수료는 없습니다. 낙찰 시 판매자 수익에서 수수료가 차감됩니다.",
    ...
    en: {
      ...
      "buyers.lead": "You can build it yourself. If that means more weekends, buying a demo-ready project may be<br />faster. No extra fee for buyers. The fee is taken from the seller’s proceeds when a deal closes.",
