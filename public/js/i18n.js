...
(function (global) {
  ...
  var STR = {
    ko: {
      ...
      "hero.title1": "잠든 프로젝트를",
      "hero.title2": "다시 사고파세요",
      "hero.sub": "데모·가격 공개. 입찰 → 결제 → 이전.<br />등록 무료 · 사이트 안에서 끝냅니다.",
    ...
    en: {
      ...
      "hero.title1": "Buy & sell",
      "hero.title2": "paused projects",
      "hero.sub": "Demo and price are public. Bid → pay → transfer.<br />Free to list · all on-site.",
