...
- [x] 사업자 정보 게시 (상호·대표·등록번호·주소·등록증) — 2026-07-29 · `/legal/business.html`
- [ ] 통신판매중개 행정 신고 번호 게시 (신고 완료 후)
...
#### A-2. 사업자 등록 이후
- [x] **약관·개인정보·푸터에 사업자 정보 보완** (상호·대표·등록번호·주소·연락처·등록증 이미지)
- [ ] 통신판매중개 신고 번호 게시 (행정 신고 완료 후)
- [ ] (권장) 약관 변호사 재검토
