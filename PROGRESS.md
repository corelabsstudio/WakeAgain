...
**저장 시점:** 2026-07-20 (제품 품질 패치 · PG/사업자/실유저 제외)  
**상태:** 제어 가능 범위 ~9점 목표 — 자동 마감 낙찰 + **상시 스케줄러** · UX9 · 진단→자랑 게이트 · 보안 헤더 · 404 · sitemap · smoke  

### 2026-07-20 품질 패치 (PG·사업자·실유저 제외)
...
- [x] smoke: showcase 게이트 · 404 · health scheduler  
...
- [ ] PG 웹훅 ↔ 성사·수수료 연동
- [ ] (권장) 마감 경매 **백그라운드 스케줄러** (1분 주기)
- [ ] 입금 확인 전 이전 금지 UX를 결제 상태와 연동

> 지금: 마감 자동 낙찰·앱 알림은 있음. **결제 링크·2순위 자동·상시 cron은 PG/추가 작업.**
